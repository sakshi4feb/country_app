...
export const Countries = () => {
    ...
    const {countries} = useAppSelector((state: { countryR: any }) => state.countryR)
    ...
    return (
            <>
                ...
                <Pagination handleChangePage={handleChangePage} handleChangeRowsPerPage={handleChangeRowsPerPage}/>
